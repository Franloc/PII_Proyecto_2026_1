namespace Library.Tests
{
    public class BibliotecaTests
    {
        ...
        public void BuildMediaAndTags_AddThemToTheBibliotec_AddedCorrectly()
        {
            ...
            //Assert.That(bibliotec.Movies, Contains.Item(starWars1));
            ...
            //Assert.That(bibliotec.Songs, Contains.Item(cumparsita));
            ...
            //Assert.That(bibliotec.Books, Contains.Item(elPrincipito));
